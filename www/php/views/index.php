        ...
        <div class="column">
            ...
            <ul>
                <div class="modal">
                    ...
                    <div class="left">
                        <img src="http://placehold.it/600x450" alt="image">
                    </div>
                    <div class="right">
                ...
                <li data-person="brenda_strong">
                    <div class="details">
                        ...
                        <span class="title">Executive Operations Director</span>
                    </div>
                    <div class="modal-content">
                ...
                <li data-person="brain_schinazi">
                    <div class="details">
                        ...
                        <span class="title">Group Technology Director</span>
                    </div>
                    <div class="modal-content">
                ...
                <li data-person="caitlin_winkworth">
                    ...
                    <div class="modal-content">
                        <span class="modal-name">Caitlin Winkworth</span>
                        <span class="modal-title">Group Analytics Director</span>
                        <span class="modal-i_am_a">I am a paddleboarder</span>
                        <span class="modal-bio">Caitlin keeps the office fashionable. She was Digital Analytics Capability Lead at PwC's Experience Center, where she led the development of their digital analytics practice, after stints at Critical Mass and SapientNitro. She’s recently been focusing using enterprise data and customer intelligence to build real-time personalized digital experiences. Caitlin is probably wearing black right now.</span>
                    </div>
                ...
                <li data-person="katie_newman">
                    <div class="details">
                        ...
                        <span class="title">Chief Marketing Officer</span>
                    </div>
                    <div class="modal-content">
                ...
                <li data-person="larry_byrne">
                    <div class="details">
                        ...
                        <span class="title">Executive Director of Production</span>
                    </div>
                    <div class="modal-content">
                        <span class="modal-name">Larry Byrne</span>
                        <span class="modal-title">Executive Director of Production</span>
                        <span class="modal-i_am_a">I am an Instigator.</span>
                        <span class="modal-bio">Larry is our man behind the man behind the camera. In a past life he was Chief Production Officer at Ogilvy, where he spent 15 years guiding global advertising production and content creation. In that time he directed goldfish, rode scaffolding tower as it collapsed, and was chased by feral dogs. When not hunting for his latest tale, Larry is an enthusiastic but speed-challenged cyclist.</span>
                    </div>
